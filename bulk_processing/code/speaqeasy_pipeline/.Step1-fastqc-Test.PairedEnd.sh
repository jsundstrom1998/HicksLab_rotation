#!/bin/bash
#SBATCH --job-name=Step1-fastqc-Test.PairedEnd
#SBATCH --output=./logs/fastqc-Test.%a.txt
#SBATCH --error=./logs/fastqc-Test.%a.txt
#SBATCH --array=1-1%100
#SBATCH --mem=7G 
             
##SBATCH --dependency=afterok:pipeline_setup,step00-merge-Test.PairedEnd
